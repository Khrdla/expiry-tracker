    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-semibold text-gray-700 mb-2">Geant Hypermarket</h2>
        ...
        <div className={`transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-16'} lg:ml-64`}>
          <main className="p-6">
            <Routes>
              ...
              <Route path="/inventory-scanning" element={<InventoryScanning user={user} />} />
