    ...
    def test_full_frontend_url(self, image_url):
        ...
        try:
            ...
            if image_url.startswith('/uploads/'):
                ...
                full_url = f"https://smart-inventory-69.preview.emergentagent.com/api/uploads/{filename}"
            else:
                full_url = f"https://smart-inventory-69.preview.emergentagent.com{image_url}"
